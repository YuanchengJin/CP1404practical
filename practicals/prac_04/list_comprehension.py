...
int_numbers = [int(number) for number in almost_numbers]
# print(int_numbers)


# TODO: list comprehension to create a list of only the numbers that are
# greater than 9 from the numbers (not strings) you just created
numbers = [number for number in int_numbers if number > 9]
print(numbers)
...
last_name = [name.split(' ',1)[1]  for name in full_names if len(name) > 11]
print(last_name)
